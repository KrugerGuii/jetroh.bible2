...
const revealItems = document.querySelectorAll(
  '.feature-row, .ai-row, .editorial-row, .faq-section > h2, .faq-list, .download-wrap, .waitlist-v2 .wl-feedback > h2, .waitlist-v2 .wl-lead, .waitlist-v2 .wl-feedback-card, .waitlist-v2 .wl-identity-card, .waitlist-v2 .wl-signup-cta, .help-form-intro, .help-contact-form'
)
